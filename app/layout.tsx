          ...
          <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
            <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
              ...
              <div className="flex items-center lg:order-2">
                ...
                <a href="#" className="text-white bg-red-500 font-bold hover:bg-red-600 focus:ring-4 focus:ring-primary-300 rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Sign in</a>
              ...
              <div className="hidden justify-between items-right w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
