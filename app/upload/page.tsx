    ...
    <><form onSubmit={handleSubmit} className="max-w-md mx-auto">
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="relative z-0 w-full mb-5 group">
            <input type="text" placeholder="" value={speaker} onChange={(e) => setVideoId(e.target.value)} required name="floating_password" id="floating_password" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-red-500 focus:outline-none focus:ring-0 focus:border-red-600 peer" />
